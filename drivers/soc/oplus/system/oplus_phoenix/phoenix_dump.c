...
/*
###############################################################################
## Copyright 2019 OPLUS Mobile Comm Corp., Ltd.
##
## File: phoenix_dump.c
...
#define FILE_DMESG                                         "/data/oplus/log/opporeserve/phoenix/kmsg"
#define PHOENIX_TEMP_DIR                                   "/data/oplus/log/opporeserve/phoenix"
#define FILE_KERNEL_EXPETION_INFO                          "/data/oplus/log/opporeserve/phoenix/ERROR_KERNEL_EXCEPTION"
...
// 1. hang oplus and filesystem ready
// 2. hang oplus and filesystem not ready(hang kernel or early native)
