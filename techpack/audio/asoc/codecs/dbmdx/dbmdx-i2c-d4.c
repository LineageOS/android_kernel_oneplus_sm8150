...
#else
int dbmd_4_8_i2c_init_interface(void)
{
	i2c_add_driver(&dbmd_4_8_i2c_driver);
	return 0;
}

void  dbmd_4_8_i2c_deinit_interface(void)
{
	i2c_del_driver(&dbmd_4_8_i2c_driver);
}

int (*dbmdx_init_interface)(void) = &dbmd_4_8_i2c_init_interface;
void (*dbmdx_deinit_interface)(void) = &dbmd_4_8_i2c_deinit_interface;
#endif
